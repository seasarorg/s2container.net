...
namespace Seasar.Tests.Quill
{
    ...
    public class QuillConfigTest
    {
        ...
        {
            using (IDbConnection connection = new SqlConnection("Server=localhost\\XXXX;database=s2dotnetdemo;Integrated Security=SSPI"))
            {
                try
                {
                    connection.Open();
                ...
                connection.ConnectionString = "Server=localhost;database=s2dotnetdemo;Integrated Security=SSPI";
                connection.Open();
                connection.Close();
