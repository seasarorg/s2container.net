...
CREATE TABLE S2DOTNETDEMO.IDENTITYTABLE (
	ID NUMBER(18, 0) NOT NULL,
	NAME VARCHAR2(20) NULL,
	CONSTRAINT PK_IDENTITYTABLE PRIMARY KEY (ID)
);

CREATE TABLE S2DOTNETDEMO.SEQTABLE (
	ID NUMBER(18, 0) NOT NULL,
	NAME VARCHAR2(20) NULL,
	CONSTRAINT PK_SEQTABLE PRIMARY KEY (ID)
);

CREATE SEQUENCE S2DOTNETDEMO.SEQ_SEQTABLE;
