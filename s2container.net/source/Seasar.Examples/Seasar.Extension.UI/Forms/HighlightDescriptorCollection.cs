...
namespace Seasar.Unit.UI.Forms
{
    ...
    public class HighLightDescriptorCollection
    {
        ...
        {
            get { return _mInnerList.IsReadOnly; }
        }

        public HighlightDescriptor this[int index]
        {
            get { return (HighlightDescriptor) _mInnerList[index]; }
            set { _mInnerList[index] = value; }
        }
        ...
        {
            get { return _mInnerList.IsFixedSize; }
        }
        ...
        {
            get { return _mInnerList.IsSynchronized; }
        }
        ...
        {
            get { return _mInnerList.SyncRoot; }
        }
