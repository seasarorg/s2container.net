...
namespace Seasar.Tests.Framework.Container.Util
{
    ...
    {
        [Test]
        public void TestIsSuitableControlクラスの場合()
        {
        ...
        [Test]
        public void TestIsSuitableFormクラスの場合()
        {
            ...
            Assert.IsFalse(AutoBindingUtil.IsSuitable(typeof(ISite), new Form(), "AcceptButton"));
            Assert.IsTrue(AutoBindingUtil.IsSuitable(typeof(ISite), new Form(), "Test"));
            Assert.IsFalse(AutoBindingUtil.IsSuitable(typeof(string), new Form(), "Text"));
        }

        [Test]
        public void TestIsSuitableFormを継承したクラスの場合()
        {
