...
namespace Seasar.Tests.FieldSelect.Impl
{
    [TestFixture]
    public class FieldSelectorImplTest
    {
        [Test]
        public void TestSelectField()
        {
            // Arrange
            var selector = new FieldSelectorImpl();
            ...
            // Act
            var result = selector.Select(target, new Quill.QuillInjectionContext());
