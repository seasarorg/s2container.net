...
{
    //  System.OracleClientを参照設定に追加している場合のみ実行可能
    //[TestFixture]
    ...
    //    {
    //        Seasar.Quill.Database.Provider.Oracle provider = new Seasar.Quill.Database.Provider.Oracle();
    //        object instance = ClassUtil.NewInstance(ClassUtil.ForName(provider.CommandType));
    //        Assert.IsNotNull(instance);
    //        Assert.IsTrue(instance is OracleCommand);
    //    }
    ...
    //        Assert.IsNotNull(instance);
    //        Assert.IsTrue(instance is OracleConnection);
    //    }
    ...
    //        Assert.IsNotNull(instance);
    //        Assert.IsTrue(instance is OracleDataAdapter);
    //    }
    ...
    //        Assert.IsNotNull(instance);
    //        Assert.IsTrue(instance is OracleParameter);
    //    }
    //}
}
