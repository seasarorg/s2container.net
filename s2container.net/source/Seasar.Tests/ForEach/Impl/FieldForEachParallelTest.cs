...
namespace Seasar.Tests.ForEach.Impl
{
    [TestFixture]
    public class FieldForEachParallelTest
    {
        [Test]
        public void TestForEach()
        {
            ...
            // Act
            actor.ForEach(entity, new Quill.QuillInjectionContext(), fields, (e, field, context) => actual.Add(field.Name));
