...
ReleaceDocUpdater.exe 1.3.10 1.3.11 index.html seasarnet.html download.html

rem s2conariner.net en
cd D:\work\OSS\Seasar\seasar_net_www\en
ReleaceDocUpdater.exe 1.3.10 1.3.11 index.html releases.html

rem s2dao.net
cd D:\work\OSS\Seasar\s2dao_net_www
ReleaceDocUpdater.exe 1.3.10 1.3.11 ja\index.html en\index.html